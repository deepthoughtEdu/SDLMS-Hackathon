...
topicsAPI.reply = async function (caller, data) {
	var payload = {
		...
		typeOfAsset: data.typeOfAsset ? data.typeOfAsset : '',
		raw:data.raw || {}
	};
	
	// if (data.typeOfAsset == "quiz:reply") { payload.quizResults = data.quizResults; }
	// if (data.typeOfAsset == "quiz") { payload.questions = data.questions; payload.answers = data.answers; }
