	...
	<div class="col-lg-12">
		<div class="clearfix">
			...
			<div class="pull-left">
				...
				<div class="btn-group" id="filter-by">
					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
						Assign role as <span class="caret"></span>
					</button>
					<ul class="dropdown-menu" role="menu">
						<li data-filter-by="teacher" role="presentation">
							<a role="menu-item" class="teacher" href="#">Teacher</a>
						</li>
						<li data-filter-by="student" role="presentation">
							<a role="menu-item" class="student" href="#">Student</a>
						</li>
						<li data-filter-by="guest" role="presentation">
							<a role="menu-item" class="guest" href="#">Guest</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<tbody>
					...
					<tr class="user-row">
						...
						<i class="notvalidated fa fa-check text-muted<!-- IF users.email:confirmed --> hidden<!-- ENDIF users.email:confirmed -->" title="not validated"></i>
						 {users.email}</td>
						<td class="user-role text-right"><!-- IF users.administrator --> administrator <!--ELSE --> <!-- IF users.userRole --> {users.userRole} <!-- ELSE --> unassigned <!-- END --> <!-- END --></td>
