<nav id="menu" class="hidden-md hidden-lg">
	...
	<section class="menu-section">
		...
		<ul class="menu-section-list">
			{{{ if user.privileges.admin:categories }}}<li><a href="{relative_path}/admin/manage/categories">[[admin/menu:manage/categories]]</a></li>
			<li><a href="{relative_path}/admin/manage/anecdotes">[[admin/menu:anecdotes]]</a></li>
			<li><a href="{relative_path}/admin/manage/rigorRank">[[admin/menu:rigorRank]]</a></li>{{{ end }}}
